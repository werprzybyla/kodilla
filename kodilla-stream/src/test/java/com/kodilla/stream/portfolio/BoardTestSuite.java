...
class BoardTestSuite {
    ...
    void testAddTaskListAverageWorkingOnTask() {
        ...
        listOfTasks.add(new TaskList("In progress"));
        long sumOfDays = project.getTaskLists().stream()
                .filter(listOfTasks::contains)
                .flatMap(l -> l.getTasks().stream())
    ...
    @Test
    void testAddTaskListAverageWorkingOnTaskDifferentWay() {
        //Given
        Board project = prepareTestData();
        ...
        double average = project.getTaskLists().stream()
                .filter(listOfTasks::contains)
                .flatMap(l -> l.getTasks().stream())
                .mapToDouble(t -> t.getCreated().until(LocalDate.now()).getDays())
                .average().getAsDouble();
